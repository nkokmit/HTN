...
DATABASES={'default':{'ENGINE':'django.db.backends.postgresql','NAME':os.getenv('POSTGRES_DB','staff_db'),'USER':os.getenv('POSTGRES_USER','staff_user'),'PASSWORD':os.getenv('POSTGRES_PASSWORD','staff_pass'),'HOST':os.getenv('POSTGRES_HOST','staff-db'),'PORT':os.getenv('POSTGRES_PORT','5432')}}
LANGUAGE_CODE='en-us'
TIME_ZONE='UTC'
USE_I18N=True
USE_TZ=True
