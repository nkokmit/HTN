...
SECRET_KEY = 'django-insecure-jh=_tdt$b-8e^*2vr&67bjrestnjr-cqo(trbdv+7w)fohbtou'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'customer_pass'),
        'HOST': os.getenv('POSTGRES_HOST', 'customer-db'),
